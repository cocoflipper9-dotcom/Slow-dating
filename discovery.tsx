...
type Profile = {
  ...
  relationGoal: string
  lifeProject: string
  /** Tailwind gradient stops used to build the abstract, photo-free avatar. */
  auraFrom: string
  auraTo: string
}
...
const PROFILES: Profile[] = [
  {
    ...
    country: 'France',
    flag: '🇫🇷',
    interests: ['Astronomie', 'Cuisine', 'Randonnée', 'Jazz', 'Photographie'],
    languages: [
    ...
    lifeProject: "Ouvrir un petit observatoire-café où l'on partage des nuits à regarder les étoiles.",
    auraFrom: 'oklch(0.32 0.06 265)',
    auraTo: 'oklch(0.2 0.02 260)',
  },
  {
    id: 'yuki',
    firstName: 'Yuki',
    ...
    country: 'Japon',
    flag: '🇯🇵',
    interests: ['Céramique', 'Cinéma', 'Thé', 'Escalade', 'Poésie'],
    languages: [
      { name: 'Japonais', level: 'Langue maternelle' },
      { name: 'Anglais', level: 'Courant' },
    ],
    relationGoal: 'Relation à distance',
    lifeProject: "Documenter les métiers d'artisanat en voie de disparition à travers le monde.",
    auraFrom: 'oklch(0.3 0.05 290)',
    auraTo: 'oklch(0.19 0.02 265)',
  },
  {
    id: 'sofia',
    firstName: 'Sofia',
    ...
    country: 'Italie',
    flag: '🇮🇹',
    interests: ['Danse', 'Architecture', 'Vélo', 'Littérature', 'Vin'],
    languages: [
    ...
    relationGoal: 'Long terme',
    lifeProject: "Restaurer une vieille bâtisse en Toscane pour en faire une résidence d'artistes.",
    auraFrom: 'oklch(0.31 0.055 255)',
    auraTo: 'oklch(0.2 0.02 270)',
  },
  {
    id: 'liam',
    firstName: 'Liam',
    ...
    country: 'Irlande',
    flag: '🇮🇪',
    interests: ['Musique', 'Voile', 'Histoire', 'Course à pied', 'Café'],
    languages: [
      { name: 'Anglais', level: 'Langue maternelle' },
      { name: 'Irlandais', level: 'Courant' },
      { name: 'Français', level: 'Débutant' },
    ],
    relationGoal: 'Amical',
    lifeProject: "Traverser l'Atlantique à la voile et écrire un carnet de bord musical.",
    auraFrom: 'oklch(0.29 0.05 275)',
    auraTo: 'oklch(0.19 0.02 258)',
  },
  {
    id: 'amara',
    firstName: 'Amara',
    ...
    country: 'Sénégal',
    flag: '🇸🇳',
    interests: ['Peinture', 'Yoga', 'Gastronomie', 'Voyages', 'Botanique'],
    languages: [
      { name: 'Wolof', level: 'Langue maternelle' },
      { name: 'Français', level: 'Langue maternelle' },
      { name: 'Anglais', level: 'Courant' },
    ],
    relationGoal: 'Court terme',
    lifeProject: "Créer un jardin partagé qui reconnecte la ville à ses plantes médicinales.",
    auraFrom: 'oklch(0.32 0.06 260)',
    auraTo: 'oklch(0.2 0.025 275)',
  },
]
...
function Avatar({ profile, size = 'md' }: { profile: Profile; size?: 'md' | 'lg' }) {
  return (
    ...
    >
      {/* Subtle texture: faint diagonal sheen, no photographic content */}
      <span
    ...
    <section aria-labelledby="discovery-title" className="flex min-h-full flex-col">
      <header className="px-6 pb-3 pt-8">
        ...
        <p className="mt-2 text-sm leading-relaxed text-muted-foreground text-pretty">
          L&apos;algorithme a sélectionné ces 5 profils uniques pour vous aujourd&apos;hui. Prenez le
